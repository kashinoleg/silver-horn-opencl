...
namespace Cloo
{
    ...
    public sealed class ComputeProgram200 : ComputeObject, IComputeProgram
    {
        #region Services
        /// <summary>
        /// Logger
            ...
            ComputeProgramBuildNotifier notify, IntPtr notifyDataPtr)
        {
            ...
            var error = OpenCL200.BuildProgram(
                Handle,
                handleCount,
                deviceHandles,
                options,
        ...
        public ICollection<IComputeKernel> CreateAllKernels()
        {
            ...
            var error = OpenCL200.CreateKernelsInProgram(
                Handle,
                0,
                null,
            ...
            error = OpenCL200.CreateKernelsInProgram(
                Handle,
                kernelsCount,
                kernelHandles,
                out kernelsCount);
