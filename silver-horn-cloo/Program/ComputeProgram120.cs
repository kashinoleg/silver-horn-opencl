...
namespace Cloo
{
    ...
    public sealed class ComputeProgram120 : ComputeObject, IComputeProgram
    {
        #region Services
        /// <summary>
        /// Logger
        ...
        public ICollection<IComputeKernel> CreateAllKernels()
        {
            ...
            var error = OpenCL120.CreateKernelsInProgram(
                Handle,
                0,
                null,
            ...
            error = OpenCL120.CreateKernelsInProgram(
                Handle,
                kernelsCount,
                kernelHandles,
                out kernelsCount);
        ...
        public string GetBuildLog(IComputeDevice device)
        {
            return GetStringInfo<CLProgramHandle, CLDeviceHandle, ComputeProgramBuildInfo>(Handle, device.Handle,
                ComputeProgramBuildInfo.BuildLog, OpenCL120.GetProgramBuildInfo);
        }
        ...
        public ComputeProgramBuildStatus GetBuildStatus(IComputeDevice device)
        {
            return (ComputeProgramBuildStatus)GetInfo<CLProgramHandle, CLDeviceHandle, ComputeProgramBuildInfo, uint>(Handle,
                device.Handle, ComputeProgramBuildInfo.Status, OpenCL120.GetProgramBuildInfo);
        }
        ...
        public List<byte[]> GetBinaries()
        {
            ...
            try
            {
                ...
                ComputeErrorCode error = OpenCL120.GetProgramInfo(
                    Handle,
