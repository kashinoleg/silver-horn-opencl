...
namespace Cloo
{
    ...
    public sealed class ComputeProgram120 : ComputeObject, IComputeProgram
    {
        ...
        {
            return GetStringInfo(Handle, device.Handle, ComputeProgramBuildInfo.BuildLog, OpenCL120.GetProgramBuildInfoWrapper);
        }
        ...
        public ComputeProgramBuildStatus GetBuildStatus(IComputeDevice device)
        {
            return (ComputeProgramBuildStatus)GetInfo<CLProgramHandle, CLDeviceHandle, ComputeProgramBuildInfo, uint>(Handle,
                device.Handle, ComputeProgramBuildInfo.Status, OpenCL120.GetProgramBuildInfoWrapper);
        }
