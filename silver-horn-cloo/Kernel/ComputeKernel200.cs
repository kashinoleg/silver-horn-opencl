...
namespace SilverHorn.Cloo.Kernel
{
    ...
    public sealed class ComputeKernel200 : ComputeObject, IComputeKernel
    {
        #region Services
        /// <summary>
        /// Logger
        ...
        {
            var error = OpenCL200.SetKernelArg(
                Handle,
                index,
                dataSize,
                dataAddr);
        ...
        public void Dispose(bool disposing)
        {
            if (!disposedValue)
            {
                ...
                if (Handle.IsValid)
                {
                    ...
                    OpenCL200.ReleaseKernel(Handle);
                    Handle.Invalidate();
                }
                disposedValue = true;
            }
