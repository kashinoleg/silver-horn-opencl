...
namespace SilverHorn.Cloo.Kernel
{
    ...
    public sealed class ComputeKernel110 : ComputeObject, IComputeKernel
    {
        #region Services
        /// <summary>
        /// Logger
        ...
        {
            var error = OpenCL110.SetKernelArg(
                Handle,
                index,
                dataSize,
                dataAddr);
        ...
        public void Dispose(bool disposing)
        {
            if (!disposedValue)
            {
                ...
                if (Handle.IsValid)
                {
                    ...
                    OpenCL110.ReleaseKernel(Handle);
                    Handle.Invalidate();
                }
                disposedValue = true;
            }
