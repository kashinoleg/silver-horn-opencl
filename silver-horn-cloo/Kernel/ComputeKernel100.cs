    ...
    public sealed class ComputeKernel100 : ComputeObject, IComputeKernel
    {
        ...
        public long GetLocalMemorySize(IComputeDevice device)
        {
            return GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, long>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.LocalMemorySize, OpenCL100.GetKernelWorkGroupInfoWrapper);
        }
        ...
        public long[] GetCompileWorkGroupSize(IComputeDevice device)
        {
            return ComputeTools.ConvertArray(
                GetArrayInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                    Handle, device.Handle, ComputeKernelWorkGroupInfo.CompileWorkGroupSize, OpenCL100.GetKernelWorkGroupInfoWrapper));
        }
        ...
        public long GetPreferredWorkGroupSizeMultiple(IComputeDevice device)
        {
            return (long)GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PreferredWorkGroupSizeMultiple, OpenCL100.GetKernelWorkGroupInfoWrapper);
        }
        ...
        {
            return GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, long>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PrivateMemorySize, OpenCL100.GetKernelWorkGroupInfoWrapper);
        }
        ...
        {
            return (long)GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                    Handle, device.Handle, ComputeKernelWorkGroupInfo.WorkGroupSize, OpenCL100.GetKernelWorkGroupInfoWrapper);
        }
