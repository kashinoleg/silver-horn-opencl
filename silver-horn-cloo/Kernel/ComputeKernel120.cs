...
namespace SilverHorn.Cloo.Kernel
{
    ...
    public sealed class ComputeKernel120 : ComputeObject, IComputeKernel
    {
        #region Services
        /// <summary>
        /// Logger
        ...
        public long GetLocalMemorySize(IComputeDevice device)
        {
            return GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, long>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.LocalMemorySize, OpenCL120.GetKernelWorkGroupInfo);
        }
        ...
        public long[] GetCompileWorkGroupSize(IComputeDevice device)
        {
            return ComputeTools.ConvertArray(
                GetArrayInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                    Handle, device.Handle, ComputeKernelWorkGroupInfo.CompileWorkGroupSize, OpenCL120.GetKernelWorkGroupInfo));
        }
        ...
        public long GetPreferredWorkGroupSizeMultiple(IComputeDevice device)
        {
            return (long)GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PreferredWorkGroupSizeMultiple, OpenCL120.GetKernelWorkGroupInfo);
        }
        ...
        {
            return GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, long>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PrivateMemorySize, OpenCL120.GetKernelWorkGroupInfo);
        }
        ...
        {
            return (long)GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                    Handle, device.Handle, ComputeKernelWorkGroupInfo.WorkGroupSize, OpenCL120.GetKernelWorkGroupInfo);
        }
        ...
        public void Dispose(bool disposing)
        {
            if (!disposedValue)
            {
                ...
                if (Handle.IsValid)
                {
                    ...
                    OpenCL120.ReleaseKernel(Handle);
                    Handle.Invalidate();
                }
                disposedValue = true;
            }
