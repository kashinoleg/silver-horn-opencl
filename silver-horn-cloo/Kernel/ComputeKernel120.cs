    ...
    public sealed class ComputeKernel120 : ComputeObject, IComputeKernel
    {
        ...
        public long[] GetCompileWorkGroupSize(IComputeDevice device)
        {
            return ComputeTools.ConvertArray(
                GetArrayInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                    Handle, device.Handle, ComputeKernelWorkGroupInfo.CompileWorkGroupSize, OpenCL120.GetKernelWorkGroupInfoWrapper));
        }
        ...
        public long GetPreferredWorkGroupSizeMultiple(IComputeDevice device)
        {
            return (long)GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PreferredWorkGroupSizeMultiple, OpenCL120.GetKernelWorkGroupInfoWrapper);
        }
        ...
        {
            return GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, long>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PrivateMemorySize, OpenCL120.GetKernelWorkGroupInfoWrapper);
        }
