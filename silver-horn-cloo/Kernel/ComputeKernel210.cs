...
namespace SilverHorn.Cloo.Kernel
{
    ...
    public sealed class ComputeKernel210 : ComputeObject, IComputeKernel
    {
        #region Services
        /// <summary>
        /// Logger
        ...
        public long GetLocalMemorySize(IComputeDevice device)
        {
            return GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, long>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.LocalMemorySize, OpenCL210.GetKernelWorkGroupInfoWrapper);
        }
        ...
        public long[] GetCompileWorkGroupSize(IComputeDevice device)
        {
            return ComputeTools.ConvertArray(
                GetArrayInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                    Handle, device.Handle, ComputeKernelWorkGroupInfo.CompileWorkGroupSize, OpenCL210.GetKernelWorkGroupInfoWrapper));
        }
        ...
        public long GetPreferredWorkGroupSizeMultiple(IComputeDevice device)
        {
            return (long)GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PreferredWorkGroupSizeMultiple, OpenCL210.GetKernelWorkGroupInfoWrapper);
        }
        ...
        {
            return GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, long>(
                Handle, device.Handle, ComputeKernelWorkGroupInfo.PrivateMemorySize, OpenCL210.GetKernelWorkGroupInfoWrapper);
        }
        ...
        {
            return (long)GetInfo<CLKernelHandle, CLDeviceHandle, ComputeKernelWorkGroupInfo, IntPtr>(
                    Handle, device.Handle, ComputeKernelWorkGroupInfo.WorkGroupSize, OpenCL210.GetKernelWorkGroupInfoWrapper);
        }
        ...
        {
            var error = OpenCL210.SetKernelArg(
                Handle,
                index,
                dataSize,
                dataAddr);
        ...
        public void Dispose(bool disposing)
        {
            if (!disposedValue)
            {
                ...
                if (Handle.IsValid)
                {
                    ...
                    OpenCL210.ReleaseKernel(Handle);
                    Handle.Invalidate();
                }
                disposedValue = true;
            }
