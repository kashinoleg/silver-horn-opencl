...
namespace Cloo
{
    ...
    public struct ComputeImageFormat
    {
        ...
        /// <summary>
        /// Gets the <see cref="ComputeImageChannelOrder"/> of the image.
        /// </summary>
        /// <value> The <see cref="ComputeImageChannelOrder"/> of the image. </value>
        public ComputeImageChannelOrder ChannelOrder { get { return channelOrder; } }

        /// <summary>
        /// Gets the <see cref="ComputeImageChannelType"/> of the image.
        /// </summary>
        /// <value> The <see cref="ComputeImageChannelType"/> of the image. </value>
        ...
        /// </summary>
        /// <param name="channelOrder"> The number of channels and the channel layout i.e. the memory layout in which channels are stored in the image. </param>
