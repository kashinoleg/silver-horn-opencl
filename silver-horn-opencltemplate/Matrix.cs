...
namespace LinearAlgebra
{
    ...
    public class Matrix
    {
        ...
        /// <summary>Returns the RІ index of last fit.</summary>
        ...
        /// <summary>Returns corrected RІ index of last fit.</summary>
        ...
        {
            //dimensхes N, k e Q. beta[0..k], X[0..N,0..k], Y[0..N], A[0..k,0..k]
            int N = this.rowCount;
        ...
        /// <summary>Calculates RІ, corrected RІ and Quadratic Error for the trySolution x to the linear system A'Ax=A'b, 
        ...
        {
            //Aplica o processo de ortonormalizaзгo de Gram Schmidt а matriz
            //corrige tambйm os coeficientes em y.

            for (int i = indStart; i < lineOrder.Length; i++)
            {
                //Remove os componentes das linhas anteriores
                //Detalhe: assume que as linhas anteriores estгo devidamente normalizadas
                for (int j = 0; j < i; j++)
                {
